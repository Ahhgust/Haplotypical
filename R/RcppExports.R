...
#' 
#' @export
fastMixtureBoundedHammingGraphDist <- function(hammingGraph, haplotypes, nInMix) {
    .Call(`_Haplotypical_fastMixtureBoundedHammingGraphDist`, hammingGraph, haplotypes, nInMix)
}
